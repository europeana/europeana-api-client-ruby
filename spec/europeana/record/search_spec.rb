...
# @todo Move or remove these tests for the DSL refactor
...
#   let(:api_key) { 'xyz' }
#   let(:params) do
#     HashWithIndifferentAccess.new(query: 'test', profile: 'standard', qf: 'where:London', rows: 100, start: 1, callback: '')
#   end
