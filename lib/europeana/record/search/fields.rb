  ...
  class Search
    ...
    module Fields
      EDM_PROVIDED_CHO = %w(edm_europeana_proxy proxy_dc_contributor
                            ...
                            proxy_ore_proxyFor proxy_ore_proxyIn).freeze
      ...
      ORE_AGGREGATION = %w(provider_aggregation_ore_aggregation
                           ...
                           provider_aggregation_edm_unstored edm_previewNoDistribute).freeze
      ...
      EDM_EUROPEANA_AGGREGATION = %w(edm_europeana_aggregation
                                     ...
                                     europeana_aggregation_ore_aggregates).freeze
      ...
      EDM_WEB_RESOURCE = %w(edm_webResource wr_dc_description wr_dc_format
                            ...
                            wr_dcterms_issued wr_edm_isNextInSequence wr_edm_rights).freeze
      ...
      EDM_AGENT = %w(edm_agent ag_skos_prefLabel ag_skos_altLabel
                     ...
                     ag_rdagr2_gender ag_rdagr2_professionOrOccupation ag_owl_sameAs).freeze
      ...
      SKOS_CONCEPT = %w(skos_concept cc_skos_prefLabel cc_skos_altLabel
                        ...
                        cc_skos_closeMatch cc_skos_note cc_skos_notation cc_skos_inScheme).freeze
      ...
      EDM_PLACE = %w(edm_place pl_wgs84_pos_lat pl_wgs84_pos_long
                     ...
                     pl_dcterms_isPartOf pl_owl_sameAs pl_dcterms_isPartOf_label).freeze
      ...
      EDM_TIME_SPAN = %w(edm_timespan ts_skos_prefLabel ts_skos_altLabel
                         ...
                         ts_dcterms_isPartOf_label).freeze

      NON_EDM = %w(europeana_completeness europeana_previewNoDistribute
                   timestamp europeana_id identifier europeana_collectionName).freeze
      ...
      FACETS = %w(COMPLETENESS CONTRIBUTOR COUNTRY DATA_PROVIDER LANGUAGE
                  LOCATION PROVIDER RIGHTS SUBJECT TYPE UGC USERTAGS YEAR).freeze

      AGGREGATED_FACETS = %w(DEFAULT).freeze
      ...
      MEDIA = %w(COLOURPALETTE IMAGE_ASPECTRATIO IMAGE_COLOR IMAGE_COLOUR
                 ...
                 SOUND_DURATION SOUND_HQ TEXT_FULLTEXT VIDEO_DURATION VIDEO_HD).freeze
